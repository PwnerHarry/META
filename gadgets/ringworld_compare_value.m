...
for result_index = 1: numel(expectation_list)
    ...
    elseif strcmp(result_name, "error_value_totd_0")
        LEGEND = "GTD(0)";
    elseif strcmp(result_name, "error_value_totd_20000")
        LEGEND = "GTD(0.2)";
    elseif strcmp(result_name, "error_value_totd_40000")
        LEGEND = "GTD(0.4)";
    elseif strcmp(result_name, "error_value_totd_60000")
        LEGEND = "GTD(0.6)";
    elseif strcmp(result_name, "error_value_totd_80000")
        LEGEND = "GTD(0.8)";
    elseif strcmp(result_name, "error_value_totd_100000")
        LEGEND = "GTD(1)";
